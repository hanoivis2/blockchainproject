from BlockchainApp.BackEnd.util.util import int_to_little_endian, encode_varint
from BlockchainApp.BackEnd.core.EllepticCurve.op import OP_CODE_FUNCTION
